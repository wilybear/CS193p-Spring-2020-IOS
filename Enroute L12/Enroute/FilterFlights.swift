...
struct FilterFlights: View {
    ...
    var destination: Binding<MKAnnotation?>{
        Binding<MKAnnotation?> (get:{
            return draft.destination //destination is Airport and it is MkAnnotation so it is legal
        }, set: { annotation in
        ...
        NavigationView {
            Form {
                Section{
                    ...
                    //airports are FetchedResults, .sorted() will return sorted Array
